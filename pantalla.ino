...
void draw_hour()   //Dibuja fecha y hora en la parte inferior de la pantalla
{
  //myGLCD.setFont(BigFont);
  myGLCD.setColor(255, 255, 255);
  myGLCD.setBackColor(12, 6, 140);
  myGLCD.print(rtc.getDOWStr(), 7, 223);        //dibuja el dia de la semana
  myGLCD.print(String(t.date), 85, 223);        //dibuja el dia del mes
  myGLCD.print(String("DE"), 113, 223);
  myGLCD.print(rtc.getMonthStr(), 140, 223);    //dibuja el mes
  myGLCD.print(String("DE"), 220, 223);
  myGLCD.print(String(t.year), 250 , 223);      //Dibuja el año
  myGLCD.print(rtc.getTimeStr(), 330, 223);     //Dibuja la fecha
}
...
void draw_screen()
{
  ...
  if (led1 != led_out1)                                 //actualiza grafico led 1
  {
    led1 = led_out1;
  ...
  if (led2 != led_out2)                                 //actualiza grafico led 2
  {
    led2 = led_out2;
  ...
  if (led3 != led_out3)                                 //actualiza grafico led 3
  {
    led3 = led_out3;
